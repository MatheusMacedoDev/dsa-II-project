...
public class ListUrlsEndpoint : IEndpoint
{
    ...
    public Task<IResult> ListAsync([FromKeyedServices("hash")] ISymbolTable<string, ShortUrl> table, AppDbContext db, ILogger<ListUrlsEndpoint> logger, CancellationToken ct) => throw new NotImplementedException();
}
